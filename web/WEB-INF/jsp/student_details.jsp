            ...
            <div class="row">
                <div class="col-2 col-md-2">
                    ...
                    <div class="list-group">
                        ...
                        <a href="evaluation.htm" class="list-group-item list-group-item-action">Liste des Evaluations</a>                        
                        <a href="classes.htm" class="list-group-item list-group-item-action">Classes</a>
                        <a href="student_information.htm" class="list-group-item list-group-item-action active">Liste des Etudiants</a>
                    </div>
                    <!--calender--><br/>
                    <div class="month">      
                        <ul>
                ...
                <div class="col-7 col-sm-12 col-md-7">
                     <div class="row">
                        ...
                        <div class="col-md-4">
                        <button type="button" class="btn" onclick="printContent('div1')">
                             Imprimer en PDF </button>
                        </div>
                    </div>
                    <div id="div1">
                            <c:forEach var="std" items="${student}">
                             <div class="container border rounded ">
                                <label>Prenom : ${std.prenom}</label><br> 
                                 <label>Nom : ${std.nom}</label><br> 
                                 <label>Date de Naissance : ${std.dateNaiss}</label><br> 
                                 <label>Numéro Dossier : ${std.codEtudiant}</label><br> 
                               </div>  
                            </c:forEach>
                             ...
                             <div class="container border rounded ">
                                    ...
                                    <thead class="thead-blue"> 
                                     ...
                                     <tr>
                                     <c:forEach var="smt" items="${evaluation}">
                                      
                                         <td>${smt.Matiere_CodeMat}</td>
                                         <td>${smt.devoir}</td>
                                         <td>${smt.examen}</td>
                                        
                                                 <c:set var ="examen" value="${smt.examen * 0.6}"/>
                                           
                                              
                                                 <c:set var ="devoir" value="${smt.devoir * 0.4}"/>
                                           
                                         
                                          </c:forEach>
                                         <td>
                                           
                                             <c:out value="${devoir+examen}"/>
                                         </td><br>
                                     </tr>
                                         ...
                                         <div class="row">
                                             <div class="col-md-8"></div>
                                             <div class="col-md-4">
                                                 Moyenne du semestre :<b> ${devoir+examen}</b>
                                             </div>

                    ...
                    <div class="row" >
                        <div class="col-12">                          
                            <div  class="container " id="div1">
                                <b>Liste de tous les étudiants: </b>
                                <table class="table table-striped">
                                    ...
                                    <c:forEach var="std" items="${students}">  
                                        <tr>
                                            <td scope="row">${std.prenom}</td>
                                            <td>${std.nom}</td>
                                            <td>${std.dateNaiss}</td>
                                            <td>${std.Classe_CodeClass}</td>


                                            <td>
                                                <button type="button" class="btn">
                                                    <a href="/DepartmentMarkManagement/student_details.htm?s_id=${std.codEtudiant}"> Details </a>
                                                </button>
                                            </td>
                                        </tr>
                                    </c:forEach>

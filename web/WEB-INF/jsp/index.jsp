            ...
            <div class="row">
                ...
                <div class="col-7 col-sm-12 col-md-7">
                    ...
                    <div class="row">
                        ...
                        <p> L’objectif de l’application est de réaliser un service web dédié aux gestion de notes du département.
                            Ce service Web comporte deux utilisateur a savoir l'administrateur et l'étudiant .<br>
                            Ainsi l'administrateur pour accéder à son espace , il faut qu'il s'authentifie une fois s'authentifier
                            il pourra consulter la listes des étudiaint, afficher la liste des evaluations, consulter la liste des 
                            matières ainsi que la liste des classes<br>
                           Pour l'étudiant il à la possibilité de consulter ses notes sur chaque matière ainsi que d'obtenir son relevé 
                           de notes.
